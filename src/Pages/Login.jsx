            ...
            <div className="w-full max-w-md mx-auto p-8 space-y-3 rounded-xl  text-gray-900">
                ...
                <form onSubmit={handleSignInUser} className="space-y-6">
                    <div className="space-y-1 text-sm">
                        ...
                        <input type="email" name="email" id="email" placeholder="email" className="w-full px-4 py-3 rounded-md border-gray-700  focus:border-violet-400" />
                    </div>
                    <div className="space-y-1 text-sm">
                ...
                <p className="text-center sm:px-6 text-gray-400 text-lg">Dont have an account?
